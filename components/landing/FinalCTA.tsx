...
export default function FinalCTA() {
  return (
    <section className="w-full bg-[#F4EFE8] py-28 md:py-40">
      <div className="max-w-2xl mx-auto px-6 flex flex-col items-center text-center">
        <motion.h2
          ...
          className="font-serif font-light text-[#080808] leading-[1.1] tracking-tight"
        ...
        <motion.p
          ...
          className="text-[rgba(8,8,8,0.5)] mt-6 leading-[1.7]"
          style={{ fontSize: "15px" }}
        >
        ...
        >
          ...
          <p
            className="text-[rgba(8,8,8,0.35)] tracking-wide"
            style={{ fontSize: "11px" }}
          >
