...
| Help Centre | P1 | ✅ on `feature/help-centre` (stages 1–8) | Content empty; Stage 9 docs this session; launch gates (support@evenzii.com, Resend/admin tickets, articles) |
